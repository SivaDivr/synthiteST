...
import pytesseract
pytesseract.pytesseract.tesseract_cmd = r"C:\Users\manju\AppData\Local\Programs\Tesseract-OCR\tesseract.exe"
import re
import io
...
def ocr_extract_text(pdf_file, psm=6):
    images = convert_from_bytes(pdf_file.read(), dpi=300,poppler_path=r"C:\Datadivr\synthiteST-main\newreq\poppler-24.08.0\Library\bin")
    all_text = []
    for img in images:
